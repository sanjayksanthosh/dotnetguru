...
import { CheckCircle2, PlayCircle, FileText, Monitor, Code } from "lucide-react";
                ...
                <div className="bg-primary pt-16 pb-24 text-white">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-3xl md:text-5xl font-bold mb-6">C# Programming Masterclass</h1>
                            <p className="text-lg md:text-xl opacity-90 leading-relaxed max-w-2xl">
                                Become a C# expert. Master one of the most popular programming languages from scratch to advanced level.
                            </p>
                            ...
                            <Card className="shadow-lg border-0">
                                <CardContent className="p-8">
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-6">
                                        Aimed at complete beginners, this course introduces programming using Visual C#.NET.
                                        It covers core concepts that apply across many languages, with a focus on building industry-oriented applications.
                                        We start from the very basics and go all the way to advanced concepts like LINQ, Multithreading, and Asynchronous programming.
                                    </p>
                                    <h3 className="text-xl font-semibold mb-4 text-gray-800">What you'll learn</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            "Master C# 10.0 syntax and features",
                                            "Object-Oriented Programming (OOP) mastery",
                                            "LINQ and Lambda Expressions",
                                            "Asynchronous Programming with Async/Await",
                                            "Working with Files, Databases & XML",
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-8">
                                ...
                                <Accordion type="single" collapsible className="w-full">
                                    <AccordionItem value="item-1">
                                        ...
                                        <AccordionContent className="text-gray-600 space-y-2 pt-2">
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                ...
                                                <span>.NET Core Overview & History</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>C# Language Basics (Variables, Data Types)</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Control Flow (If/Else, Loops, Switch)</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                    ...
                                    <AccordionItem value="item-2">
                                        <AccordionTrigger className="text-lg font-semibold hover:text-primary">
                                            Phase II: Object-Oriented Programming
                                        </AccordionTrigger>
                                        <AccordionContent className="text-gray-600 space-y-2 pt-2">
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Classes, Objects & Constructors</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                            ...
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Encapsulation, Properties & Indexers</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                    ...
                                    <AccordionItem value="item-3">
                                        <AccordionTrigger className="text-lg font-semibold hover:text-primary">
                                            Phase III: Advanced C#
                                        </AccordionTrigger>
                                        <AccordionContent className="text-gray-600 space-y-2 pt-2">
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Collections & Generics</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Delegates, Events & Lambda Expressions</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>LINQ (Language Integrated Query)</span>
                                            </div>
                                            <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                                                <PlayCircle size={16} className="text-primary" />
                                                <span>Async/Await & Multithreading</span>
                                            </div>
                                        </AccordionContent>
                                    </AccordionItem>
                                </Accordion>
                                ...
                                <Card className="overflow-hidden shadow-xl border-0">
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-baseline gap-2 mb-4">
                                            ...
                                            <span className="text-gray-400 line-through">₹10000</span>
